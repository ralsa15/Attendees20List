...
define(['text!usernamebox.html'], function( htmlString) {

	/**
	 * COMPONENT MODEL CONSTRUCTOR
	 */
	function usernamebox( params) { 
//debugger;		
...
//								"ReadOnlyField": false,
    ...
    return { viewModel: usernamebox, template: htmlString };
});


 //@ sourceURL=usernamebox